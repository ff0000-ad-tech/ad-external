...
class Velvet {
	static _baseUrlLive = 'https://json.ff0000-cdn.net/'
	static _baseUrlPreview = 'https://preview.ff0000-cdn.net/preview/'
	static _qaBaseUrlLive = 'https://qa.ff0000-cdn.net/'
	static _qaBaseUrlPreview = 'https://qa.velvet.tech/preview/'
	static _baseUrlNow = undefined
	static _baseSlugs = undefined
	static _settings = undefined
	static _debug = false
	static _resolved = undefined
	...
	*/
	static init = function(settings) {
		...
		if (isQA) {
			...
			V._baseUrlLive = V._qaBaseUrlLive
			V._baseUrlPreview = V._qaBaseUrlPreview
		}
	...
	*/
	static isPreviewLocation = function() {
		const V = this
	...
	/* ------------------------------------------------------------------------------------------------------------- */
	// EVENT HANDLERS
	static _handleSegmentLoadComplete = function(event) {
		const V = this
		...
		V._settings.adData = MathUtils.randomWeightedKey(rotation)
		console.log('\tselected ad slug:', V._settings.adData)

		if (V._settings.adData === 'USE_STATIC') {
			useStatic()
			return
		}
	...
	static _handleAdDataLoadComplete = function(event) {
		const V = this
